...
function Chevron() {
  return (
    <svg className="w-3.5 h-3.5 text-text-ghost shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function RelationshipRisks({ items }: RelationshipRisksProps) {
  ...
  if (riskItems.length === 0) {
    return (
      <div className="bg-surface-sidebar border border-border-subtle rounded-xl p-4">
        <h2 className="text-sm font-semibold text-text-primary mb-2">Relationship Risks</h2>
        <p className="text-xs text-text-dim">All relationships are warm.</p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-surface-sidebar border border-border-subtle rounded-xl p-4">
      <h2 className="text-sm font-semibold text-text-primary mb-1">Relationship Risks</h2>
        ...
        {shown.map(item => {
          ...
          return (
            <Link
              ...
              className="flex items-center gap-3 py-2.5 border-b border-border-subtle last:border-0 hover:bg-[rgba(255,255,255,0.02)] -mx-4 px-4 transition-colors"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className="text-text-dim text-sm font-normal"> — {description}</span>
              </div>
